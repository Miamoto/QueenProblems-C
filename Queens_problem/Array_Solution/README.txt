...
Running the tests: Run the program by typing make in the console and after that type ./queens N, where N is the
				   NxN problem with N Queens. The output will give all the possible answers for the N queen problem.
